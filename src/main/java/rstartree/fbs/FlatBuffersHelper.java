...
final class FlatBuffersHelper {
    ...
    static <T, S extends Geometry> int addEntries(List<Entry<T, S>> entries,
        ...
        int b = Box_.createBox_(builder, mbb.id(), mbb.x1(), mbb.y1(), mbb.x2(), mbb.y2(), mbb.prob());
    ...
    static <S extends Geometry> S toGeometry(Geometry_ g) {
        ...
        if (type == GeometryType_.Box) {
            ...
            Point_ p = g.point();
            result = Geometries.point(0,0,p.x(), p.y(),0);
    ...
    static Rectangle createBox(Box_ b) {
        return Geometries.rectangle((int)b.id(), b.minX(), b.minY(), b.maxX(), b.maxY(), b.prob());
    }

    static Line createLine(Box_ b) {
        return Geometries.line((int)b.id(), b.minX(), b.minY(), b.maxX(), b.maxY(), b.prob());
    }
