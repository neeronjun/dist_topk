...
import rstartree.InternalStructure;
import rstartree.Leaf;
import rstartree.Node;
import rstartree.NonLeaf;
import rstartree.RTree;
import rstartree.SelectorRStar;
import rstartree.Serializer;
import rstartree.SerializerHelper;
import rstartree.SplitterRStar;
import rstartree.fbs.generated.Box_;
import rstartree.fbs.generated.Context_;
import rstartree.fbs.generated.Node_;
import rstartree.fbs.generated.Tree_;
import rstartree.geometry.Geometries;
import rstartree.geometry.Geometry;
import rstartree.geometry.Rectangle;
import rstartree.internal.LeafDefault;
...
public final class SerializerFlatBuffers<T, S extends Geometry> implements Serializer<T, S> {
    ...
    public void write(RTree<T, S> tree, OutputStream os) throws IOException {
        ...
        if (tree.root().isPresent()) {
            ...
            mbb = Geometries.rectangle(0,0,0, 0, 0, 0);
        }
     ...
     * java.io.InputStream, InternalStructure)
     */
    @Override
