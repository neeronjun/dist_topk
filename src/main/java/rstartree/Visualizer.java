...
public final class Visualizer {
    ...
    protected <T, S extends Geometry> List<RectangleDepth> getRectangleDepths(Node<T, S> node,
                                                                              int depth) {
    ...
    private void drawNode(Graphics2D g, List<RectangleDepth> nodes) {
        for (final RectangleDepth node : nodes) {
            ...
            System.out.println("Depth = "+node.getDepth()+"\tx1:"+r.x1() + "\ty1:" +r.y1() + "\tx2:" + r.x2() + "\ty2:" + r.y2()+"\n");
            drawRectangle(g, r);
        }
    }
